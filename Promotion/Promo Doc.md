...
- Scaffolded the freemium system using the microservice generator and brought it up to production. Converted the repo into a monorepo with multiple services, set up the pipelines to accommodate the new structure, created shared packages to simplify the 
