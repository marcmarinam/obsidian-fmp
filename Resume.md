...
- **Built a Snowplow Signals pipeline** (an early pilot deployment) to construct per-user behaviour profiles from site activity — driving targeted in-app and email nudges based on what each user actually engages with.
